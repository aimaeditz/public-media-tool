    ...
    <section className="py-10 sm:py-16 md:py-20 bg-white">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-6 sm:mb-12 gap-3 sm:gap-4">
          <div>
            <span className="text-[11px] sm:text-xs font-bold uppercase tracking-widest text-pink-600 px-3 py-1 bg-pink-50 rounded-full border border-pink-100 inline-flex items-center gap-1">
              <Sparkles className="w-3.5 h-3.5 text-pink-500" /> Fresh Updates
            </span>
            <h2 className="text-2xl sm:text-4xl font-extrabold font-heading text-slate-900 mt-1.5 sm:mt-2">
              Latest Additions
            </h2>
            <p className="text-xs sm:text-sm text-slate-600 mt-1">Fresh tools added recently to expand your browser toolkit.</p>
          </div>
          ...
          {latestTools.map((tool) => {
            ...
            return (
              <div
                ...
                className="group bg-slate-50/80 hover:bg-white rounded-2xl p-4 sm:p-5 border border-slate-200/80 hover:border-indigo-300 hover:shadow-xl transition-all duration-300 flex flex-col justify-between cursor-pointer hover:-translate-y-1 relative"
              >
                <div>
                  <div className="flex items-center justify-between mb-3 sm:mb-4">
                    ...
                    <span className="text-[10px] font-bold px-2 py-0.5 bg-white text-slate-600 border border-slate-200 rounded-full">
                      {tool.category}
                    </span>
                  </div>

                  <h3 className="font-heading font-bold text-sm sm:text-base text-slate-900 group-hover:text-indigo-600 transition-colors">
                    {tool.name}
                  </h3>
                ...
                <div className="pt-3 sm:pt-4 mt-3 sm:mt-4 border-t border-slate-200/60 flex items-center justify-between">
