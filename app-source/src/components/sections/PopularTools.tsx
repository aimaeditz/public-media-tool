  ...
  return (
    <section className="py-10 sm:py-20 md:py-28 bg-white border-b border-slate-200/60">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-nowrap sm:flex-wrap overflow-x-auto scrollbar-none justify-start sm:justify-center gap-1.5 sm:gap-2 mb-6 sm:mb-10 pb-2 sm:pb-0 px-1">
          {filterChips.map((chip) => {
            ...
            return (
              <button
                ...
                className={`px-3 sm:px-4 py-1.5 sm:py-2 text-[11px] sm:text-xs font-semibold rounded-full transition-all cursor-pointer shrink-0 ${
                  isActive
          ...
          {visibleTools.map((tool) => {
            ...
            return (
              <div
                ...
                className="group bg-white rounded-2xl p-4 sm:p-5 border border-slate-200/80 hover:border-indigo-300 hover:shadow-xl transition-all duration-300 flex flex-col justify-between cursor-pointer hover:-translate-y-1 relative"
              >
                <div>
                  <div className="flex items-center justify-between mb-3 sm:mb-4">
                    <div className="p-2.5 sm:p-3 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 text-white shadow-xs group-hover:scale-105 transition-transform">
        ...
        {visibleCount < filteredTools.length && (
          <div className="text-center mt-8 sm:mt-12">
            <button
              ...
              className="px-6 sm:px-8 py-2.5 sm:py-3 text-xs font-bold text-slate-800 bg-white hover:bg-slate-100 border border-slate-300 rounded-xl shadow-xs transition-all cursor-pointer"
            >
