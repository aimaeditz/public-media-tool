    ...
    "howToUse": [
      {
        "step": 1,
        "title": "Paste String",
        "desc": "Type URL string in input field."
      },
      {
        "step": 2,
        "title": "Select Encode or Decode",
        "desc": "Click encode or decode button."
      },
      {
        "step": 3,
        "title": "Copy Escaped Output",
        "desc": "Copy safe percent-encoded string."
      }
    ],
    "faqs": [
      {
        "question": "What characters are encoded by encodeURIComponent?",
        "answer": "Encodes all characters except A-Z a-z 0-9 - _ . ! ~ * ' ( )"
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        ...
        "desc": "Paste eyJhbGciOiJKV1QiLC..."
      },
      {
        "step": 2,
        "title": "Inspect JSON Sections",
        "desc": "Decodes Base64Url header and payload JSON objects."
      },
      {
        "step": 3,
        "title": "Check Expiration Status",
        "desc": "Checks `exp` timestamp against current time."
      }
    ],
    "faqs": [
      {
        "question": "Is my JWT sent to a remote server?",
        "answer": "No, decoding takes place 100% locally in your client browser session."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        "step": 1,
        "title": "View Current Device Specs",
        "desc": "Auto-detects active browser session capabilities."
      },
      {
        "step": 2,
        "title": "Paste Custom UA String",
        "desc": "Optionally paste external User-Agent string to parse."
      },
      {
        "step": 3,
        "title": "Read Hardware Breakdown",
        "desc": "View OS name, CPU arch, rendering engine, and screen DPI."
      }
    ],
    "faqs": [
      {
        "question": "What is devicePixelRatio?",
        "answer": "Ratio of physical display pixels to CSS logical pixels (e.g. Retina displays = 2 or 3)."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        ...
        "desc": "Choose A, CNAME, MX, or TXT."
      },
      {
        "step": 2,
        "title": "View record syntax",
        "desc": "Inspect example records and TTL values."
      },
      {
        "step": 3,
        "title": "Validate domain string",
        "desc": "Tests syntax correctness for zone files."
      }
    ],
    "faqs": [
      {
        "question": "What is a CNAME record?",
        "answer": "Canonical Name alias mapping one domain name to another domain."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        "step": 1,
        "title": "Enter IP address & CIDR prefix",
        "desc": "E.g. 192.168.1.1/24."
      },
      {
        "step": 2,
        "title": "Calculate subnet",
        "desc": "Computes Network IP, Broadcast IP, Netmask (255.255.255.0)."
      },
      {
        "step": 3,
        "title": "Read usable host count",
        "desc": "Displays total usable IP addresses (254 hosts)."
      }
    ],
    "faqs": [
      {
        "question": "How many usable IPs in a /24 subnet?",
        "answer": "254 usable IPs (256 total minus Network .0 and Broadcast .255)."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        "step": 1,
        "title": "Enter IPv6 address",
        "desc": "E.g. 2001:0db8:0000:0000:0000:8a2e:0370:7334."
      },
      {
        "step": 2,
        "title": "Click Compress / Expand",
        "desc": "Converts to 2001:db8::8a2e:370:7334 or expands fully."
      },
      {
        "step": 3,
        "title": "Copy converted address",
        "desc": "Copy string."
      }
    ],
    "faqs": [
      {
        "question": "What does \"::\" mean in IPv6?",
        "answer": "Replaces a single contiguous run of zeros with double colons."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        "step": 1,
        "title": "Search code or keyword",
        "desc": "Type 401, 403, 502, \"unauthorized\", \"gateway\"."
      },
      {
        "step": 2,
        "title": "Read specifications",
        "desc": "View RFC descriptions, server causes, and client fixes."
      },
      {
        "step": 3,
        "title": "Copy HTTP code snippet",
        "desc": "Copy code reference."
      }
    ],
    "faqs": [
      {
        "question": "What is difference between 401 and 403 status codes?",
        "answer": "401 means Unauthenticated (missing credentials); 403 means Forbidden (authenticated but lacking permissions)."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        "step": 1,
        "title": "Paste raw HTTP headers block",
        "desc": "Paste raw HTTP text."
      },
      {
        "step": 2,
        "title": "Parse headers",
        "desc": "Extracts status code and header key-value dictionary."
      },
      {
        "step": 3,
    ...
    "faqs": [
      {
        "question": "Is header name case-sensitive?",
        "answer": "HTTP header names are case-insensitive per HTTP specifications."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        "step": 1,
        "title": "Paste text or HTML string",
        "desc": "Type input string."
      },
      {
        "step": 2,
        "title": "Select Encode or Decode",
        "desc": "Converts < to &lt;, > to &gt;, & to &amp;."
      },
      {
        "step": 3,
        "title": "Copy escaped markup",
        "desc": "Copy output."
      }
    ],
    "faqs": [
      {
        ...
        "answer": "To safely display markup code as plain text without rendering as active DOM tags."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        "step": 1,
        "title": "Paste raw cookie string",
        "desc": "E.g. session_id=123; theme=dark; analytics_id=xyz;"
      },
      {
        "step": 2,
        "title": "Parse to JSON",
        "desc": "Extracts key-value dictionary."
      },
      {
        "step": 3,
        "title": "Copy JSON object",
        "desc": "Copy output JSON."
      }
    ],
    "faqs": [
      {
        "question": "How are cookies separated in document.cookie?",
        "answer": "Separated by semicolon and space (; )."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        ...
        "desc": "E.g. https://example.com/shop?cat=shoes&sort=price&page=2"
      },
      {
        "step": 2,
        "title": "Extract parameter table",
        "desc": "Lists all query keys and decoded values."
      },
      {
        "step": 3,
        "title": "Add/Edit params & rebuild URL",
        "desc": "Re-generates updated URL."
      }
    ],
    "faqs": [
      {
        "question": "Does it handle array parameters like ?tags=a&tags=b?",
        "answer": "Yes, groups duplicate keys into array values."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        ...
        "desc": "E.g. https://example.com/landing-page."
      },
      {
        "step": 2,
        "title": "Enter Campaign Source & Medium",
        "desc": "E.g. source=newsletter, medium=email."
      },
      {
        "step": 3,
        "title": "Enter Campaign Name",
        "desc": "E.g. campaign=summer_sale."
      }
    ],
    "faqs": [
      {
        "question": "Are UTM parameters case-sensitive in Google Analytics?",
        "answer": "Yes, \"Newsletter\" and \"newsletter\" track as separate sources in GA4 reports."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        ...
        "desc": "Default * or specific Googlebot/Bingbot."
      },
      {
        "step": 2,
        "title": "Add Disallow / Allow paths",
        "desc": "E.g. Disallow: /admin/ and /private/."
      },
      {
        "step": 3,
        "title": "Add Sitemap URL",
        "desc": "E.g. Sitemap: https://example.com/sitemap.xml."
      }
    ],
    "faqs": [
      {
        "question": "Where must robots.txt be placed?",
        "answer": "In the root web directory at https://domain.com/robots.txt"
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        "step": 1,
        "title": "Enter list of page URLs",
        "desc": "Type one URL per line."
      },
      {
        "step": 2,
        "title": "Set changefreq & priority",
        "desc": "Select daily, weekly, or monthly."
      },
      {
        "step": 3,
        "title": "Download sitemap.xml",
        "desc": "Copy formatted XML sitemap."
      }
    ],
    "faqs": [
      {
        "question": "What is maximum URL limit per sitemap.xml file?",
        "answer": "Max 50,000 URLs and max 50 MB uncompressed size per file."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        "step": 1,
        "title": "Enter Page Title & Description",
        "desc": "Type social title and summary text."
      },
      {
        "step": 2,
        "title": "Enter Image URL",
        "desc": "Provide 1200x630 banner photo link."
      },
      {
        "step": 3,
        "title": "Copy HTML <head> tags",
        "desc": "Paste into webpage <head> section."
      }
    ],
    "faqs": [
      {
        "question": "What is ideal image size for Open Graph social cards?",
    ...
    "howToUse": [
      {
        ...
        "desc": "Choose Article, Product, FAQPage, or LocalBusiness."
      },
      {
        "step": 2,
        "title": "Fill schema fields",
        "desc": "Type name, author, price, question/answers."
      },
      {
        "step": 3,
        "title": "Copy <script type=\"application/ld+json\"> snippet",
        "desc": "Paste into HTML."
      }
    ],
    "faqs": [
      {
        "question": "Why use JSON-LD for SEO?",
        "answer": "Helps search engines understand page entity context and enables rich search result snippets."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        "step": 1,
        "title": "Toggle flex-direction",
        "desc": "Row, Column, Row-reverse."
      },
      {
        "step": 2,
        "title": "Select justify-content & align-items",
        "desc": "Flex-start, Center, Space-between, Stretch."
      },
      {
        "step": 3,
        "title": "Copy CSS code snippet",
        "desc": "Copy generated CSS stylesheet rule."
      }
    ],
    "faqs": [
      {
        "question": "What does space-between do in Flexbox?",
        "answer": "Distributes items evenly; first item is at start edge, last item at end edge."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        "step": 1,
        "title": "Set column count & fr ratios",
        "desc": "E.g. repeat(3, 1fr) or 200px 1fr 1fr."
      },
      {
        "step": 2,
        "title": "Set grid gap spacing",
        "desc": "E.g. 16px gap."
      },
      {
        "step": 3,
        "title": "Copy CSS code snippet",
        "desc": "Copy CSS grid container styles."
      }
    ],
    "faqs": [
      {
        "question": "What does 1fr unit mean in CSS Grid?",
        "answer": "1 fraction of the available free space inside the grid container."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        "step": 1,
        "title": "Adjust Blur amount (px)",
        "desc": "E.g. backdrop-filter: blur(12px)."
      },
      {
        "step": 2,
        "title": "Adjust background opacity",
        "desc": "E.g. rgba(255,255,255,0.15)."
      },
      {
        "step": 3,
        "title": "Copy CSS rules",
        "desc": "Copy glass stylesheet declarations."
      }
    ],
    "faqs": [
      {
        "question": "Is backdrop-filter supported in all modern browsers?",
        "answer": "Yes, supported in all modern Chrome, Safari, Firefox, and Edge browsers."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        "step": 1,
        "title": "Adjust X and Y offsets",
        "desc": "Set horizontal and vertical shadow distance."
      },
      {
        "step": 2,
        "title": "Set Blur and Spread radius",
        "desc": "Set softness and expansion."
      },
      {
        "step": 3,
        "title": "Copy box-shadow CSS code",
        "desc": "Copy generated CSS rule."
      }
    ],
    "faqs": [
      {
        "question": "How to create soft elevated card shadows?",
        "answer": "Use multiple layered box-shadow declarations with low opacity."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        "step": 1,
        "title": "Adjust 4 corner handles",
        "desc": "Set top-left, top-right, bottom-right, bottom-left values."
      },
      {
        "step": 2,
        "title": "Toggle 8-point percentage handles",
        "desc": "Generates organic fluid blob shapes."
      },
      {
        "step": 3,
        "title": "Copy border-radius CSS",
        "desc": "Paste into CSS stylesheet."
      }
    ],
    "faqs": [
      {
        "question": "What is 8-value border-radius syntax?",
        "answer": "E.g. border-radius: 60% 40% 30% 70% / 60% 30% 70% 40%;"
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        ...
        "desc": "Linear or Radial."
      },
      {
        "step": 2,
        "title": "Add color stops & set angle",
        "desc": "Set gradient direction angle (0° to 360°)."
      },
      {
        "step": 3,
        "title": "Copy CSS background code",
        "desc": "Copy CSS background declaration."
      }
    ],
    "faqs": [
      {
        "question": "How to make 45-degree angle gradient?",
        "answer": "background: linear-gradient(45deg, #color1, #color2);"
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        "step": 1,
        "title": "Select animation preset or edit keyframes",
        "desc": "0%, 50%, 100% keyframe steps."
      },
      {
        "step": 2,
        "title": "Set duration & timing function",
        "desc": "E.g. 1s ease-in-out infinite."
      },
      {
        "step": 3,
        "title": "Copy @keyframes CSS snippet",
        "desc": "Copy CSS code."
      }
    ],
    "faqs": [
      {
        "question": "What is transition-timing-function cubic-bezier?",
        "answer": "Custom mathematical acceleration curve for smooth motion."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        ...
        "desc": "Choose row count and column count."
      },
      {
        "step": 2,
        "title": "Type cell content",
        "desc": "Enter table header and data cell text."
      },
      {
        "step": 3,
        "title": "Copy HTML & CSS",
        "desc": "Copy responsive table markup."
      }
    ],
    "faqs": [
      {
        "question": "How to make HTML table responsive on mobile screen?",
        "answer": "Wrap <table> inside a container element with CSS overflow-x: auto."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        ...
        "desc": "Choose row and column count."
      },
      {
        "step": 2,
      ...
      },
      {
        ...
        "desc": "Paste into GitHub README.md file."
      }
    ],
    "faqs": [
      {
        "question": "How to right-align a Markdown table column?",
        "answer": "Use three dashes followed by a colon (---:)."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        ...
        "desc": "E.g. https://example.com/embed."
      },
      {
        "step": 2,
        "title": "Select aspect ratio preset",
        "desc": "16:9, 4:3, or custom dimensions."
      },
      {
        "step": 3,
        "title": "Toggle sandbox flags",
        "desc": "Check allow-scripts, allow-same-origin."
      }
    ],
    "faqs": [
      {
        "question": "Why wrap iframe in aspect ratio CSS container?",
        "answer": "Prevents video or canvas embeds from overflowing mobile viewports."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        ...
        "desc": "Enter vector markup."
      },
      {
        "step": 2,
        "title": "Convert to Data URI",
        "desc": "Percent-escapes special vector characters."
      },
      {
        "step": 3,
        "title": "Copy CSS background rule",
        "desc": "Paste directly into CSS stylesheet."
      }
    ],
    "faqs": [
      {
        "question": "Why percent-encode SVG instead of Base64 in CSS?",
        "answer": "Percent-encoded SVG strings are smaller in file size and easier to inspect in CSS."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        "step": 1,
        "title": "Enter Font Family name",
        "desc": "E.g. \"CustomSans\"."
      },
      {
        "step": 2,
        "title": "Enter font file paths",
        "desc": "Specify .woff2 and .woff file URLs."
      },
      {
        "step": 3,
        "title": "Set font-weight & font-display",
        "desc": "Choose 400, 700 and font-display: swap."
      }
    ],
    "faqs": [
      {
        "question": "Why use font-display: swap?",
        "answer": "Ensures fallback text displays immediately while custom web font downloads to prevent flash of invisible text (FOIT)."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        "step": 1,
        "title": "Select CSS framework preset",
        "desc": "Choose Tailwind CSS, Bootstrap 5, or Bulma."
      },
      {
        "step": 2,
        "title": "View pixel range breakdown",
        "desc": "Inspect sm (640px), md (768px), lg (1024px), xl (1280px)."
      },
      {
        "step": 3,
        "title": "Copy media query CSS code",
        "desc": "Copy @media (min-width: ...) rules."
      }
    ],
    "faqs": [
      {
        "question": "What is mobile-first responsive design?",
        "answer": "Writing default styles for mobile screens first, then adding min-width media queries for larger displays."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        "step": 1,
        "title": "Inspect local storage keys",
        "desc": "Lists all LocalStorage key names and string lengths."
      },
      {
        "step": 2,
        "title": "Query Storage Estimate API",
        "desc": "Calls navigator.storage.estimate()."
      },
      {
        "step": 3,
        "title": "Read MB used vs quota available",
        "desc": "Displays total storage usage."
      }
    ],
    "faqs": [
      {
        "question": "What is standard LocalStorage limit in web browsers?",
        "answer": "Typically 5 MB per origin domain."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        "step": 1,
        "title": "Open tool in two separate browser tabs",
        "desc": "Connects to shared channel name."
      },
      {
        "step": 2,
        "title": "Type message & click Broadcast",
        "desc": "Sends message payload."
      },
      {
        "step": 3,
        "title": "Observe real-time sync",
        "desc": "Other open tab receives event payload instantly."
      }
    ],
    "faqs": [
      {
        "question": "What is BroadcastChannel API?",
        "answer": "A native web API allowing simple pub/sub communication between tabs/windows of the same origin."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        "step": 1,
        "title": "Type speech text",
        "desc": "Enter message to speak."
      },
      {
        "step": 2,
        "title": "Select system voice",
        "desc": "Choose from installed browser voices."
      },
      {
        "step": 3,
        "title": "Adjust rate & pitch sliders",
        "desc": "Click Speak to trigger audio synthesis."
      }
    ],
    "faqs": [
      {
        "question": "Are extra audio libraries required for Web Speech TTS?",
        "answer": "No, window.speechSynthesis is natively built into all modern web browsers."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        "step": 1,
        "title": "Select Web Vital metric",
        "desc": "Choose LCP, INP, or CLS."
      },
      {
        "step": 2,
        "title": "Read target threshold",
        "desc": "LCP < 2.5s (Good), INP < 200ms, CLS < 0.1."
      },
      {
        "step": 3,
        "title": "View fix recommendations",
        "desc": "Read actionable frontend optimizations."
      }
    ],
    "faqs": [
      {
        "question": "What metric replaced FID in 2024?",
        "answer": "Interaction to Next Paint (INP) replaced First Input Delay (FID) as an official Core Web Vital in March 2024."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        "step": 1,
        "title": "Enter primary canonical URL",
        "desc": "E.g. https://example.com/products/shoes."
      },
      {
        "step": 2,
        "title": "Generate canonical HTML tag",
        "desc": "Creates <link rel=\"canonical\" href=\"...\">."
      },
      {
        "step": 3,
        "title": "Paste into <head>",
        "desc": "Embed in webpage."
      }
    ],
    "faqs": [
      {
        "question": "Why are canonical tags vital for ecommerce sites?",
        "answer": "Consolidates SEO link equity across paginated or parameterized product filter URLs."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        "step": 1,
        "title": "Add language & country codes",
        "desc": "E.g. en-US, es-ES, fr-FR, x-default."
      },
      {
        "step": 2,
        "title": "Enter regional URL mappings",
        "desc": "Provide localized page links."
      },
      {
        "step": 3,
        "title": "Copy hreflang block",
        "desc": "Paste into HTML <head>."
      }
    ],
    "faqs": [
      {
        "question": "What is x-default hreflang reserved for?",
        "answer": "Fallback link for international users whose language is not explicitly listed."
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        "step": 1,
        "title": "Enter App Name & Short Name",
        "desc": "E.g. \"My Application\"."
      },
      {
        "step": 2,
        "title": "Set theme_color & background_color",
        "desc": "Choose hex colors."
      },
      {
        "step": 3,
        "title": "Set display mode & download JSON",
        "desc": "Select standalone, minimal-ui, or browser."
      }
    ],
    "faqs": [
      {
        "question": "Where is manifest.json linked in HTML?",
        "answer": "<link rel=\"manifest\" href=\"/manifest.json\">"
      }
    ]
  },
  {
    ...
    "howToUse": [
      {
        "step": 1,
        "title": "Enter attribute key & value",
        "desc": "E.g. data-user-role=\"admin\"."
      },
      {
        "step": 2,
        "title": "Generate HTML markup",
        "desc": "Creates <div data-user-role=\"admin\">."
      },
      {
        "step": 3,
        "title": "Copy JS dataset code",
        "desc": "Copy element.dataset.userRole."
      }
    ],
    "faqs": [
      {
        "question": "How is data-user-role accessed in JavaScript?",
        "answer": "Via camelCase property: element.dataset.userRole."
      }
    ]
  }
];
