      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div className="bg-white rounded-3xl border border-slate-200/80 p-6 shadow-sm space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-2 max-h-[160px] overflow-y-auto p-1 border border-slate-100 rounded-2xl bg-slate-50/50 scrollbar-thin">
              <button
                onClick={() => setSelectedParent('All')}
                className={`px-4 py-2 rounded-xl text-xs font-bold transition-all duration-150 cursor-pointer border ${
                  selectedParent === 'All'
