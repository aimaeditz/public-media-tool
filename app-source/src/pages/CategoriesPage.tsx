      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="bg-white rounded-3xl border border-slate-200/80 p-6 shadow-sm space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-2 p-1 border border-slate-100 rounded-2xl bg-slate-50/50">
              <button
                  ...
                  >
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        <div className={`w-11 h-11 rounded-xl flex items-center justify-center bg-gradient-to-br ${cat.colorGradient} text-white shadow-sm shadow-indigo-500/10`}>
                      ...
                      {/* Department Chip */}
                      <div>
                        <span className="text-[11px] font-semibold text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded-md border border-indigo-100/60 inline-block">
