...
export const ToolDetailPage: React.FC<ToolDetailPageProps> = ({ slug, navigate }) => {
  ...
  return (
    <div className="pt-10 pb-24 sm:pb-32 lg:pb-36 bg-slate-50 min-h-screen">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-xs flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left mt-10">
