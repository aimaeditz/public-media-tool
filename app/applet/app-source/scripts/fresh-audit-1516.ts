...
async function runFreshOneByOneAudit() {
  ...
  fs.writeFileSync('/app/applet/FULL_AUDIT_REPORT_TOOLS_1_TO_1516_MEANINGFUL.txt', reportText, 'utf8');
  fs.writeFileSync('/app/applet/app-source/public/FULL_AUDIT_REPORT_TOOLS_1_TO_1516_MEANINGFUL.txt', reportText, 'utf8');
  fs.writeFileSync('/app/applet/real_tested_tools_1_1516_meaningful.json', JSON.stringify(results, null, 2), 'utf8');
